                    ...
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item active" href="">Nhân viên</a>
                        ...
                        <table class="table">
                            ...
                            <tbody align="center">
                              <?php  foreach($result as $data => $value):?>
                                <tr>
                                    <th scope="row"><b><?php echo $value->emp_name?></b></th>
                                    <th scope="row"><b><?php echo $value->emp_user?></b></th>
                                    <td><b><?php echo $value->type_emp?></b></td>
                                    <td><b><?php echo $value->branch_name?></b></td>
